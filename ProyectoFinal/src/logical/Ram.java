...
public class Ram extends Memoria {
	...
	public Ram(float precio, int cant, String num_serie, String marca, String modelo, float cantGB, String tipoDDR,
			float speed, boolean multiCHSUP) {
		super(precio, cant, num_serie, marca, modelo, cantGB);
